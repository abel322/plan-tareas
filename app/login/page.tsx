...
import { Network, LogIn, AlertCircle, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-intelligence/15 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/3 w-96 h-96 bg-electric-cyan/15 rounded-full blur-3xl" />
      </div>
        ...
        <Card className="border-border/40 backdrop-blur-sm bg-background/80 shadow-2xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-text-tertiary">
              Introduce tus datos de acceso a continuación
            </CardDescription>
          </CardHeader>
          <CardContent>
